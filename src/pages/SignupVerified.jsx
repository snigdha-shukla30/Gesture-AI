...
export default function SignupVerified() {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="rounded-[16px] w-[1000px] h-[600px] p-0 flex" // ✅ yaha flex laga diya
          style={{
            background: "#04122F",
        ...
        >
          ...
          <div className="w-1/2 p-6 flex flex-col justify-center">
            ...
            <div className="flex flex-col mb-6 gap-2">
              ...
              >
                No more problem in understanding sign language from now.
              </p>
            </div>
            ...
            <div className="relative mb-4">
              ...
              {/* ✅ Image in place of span */}
              <img
                src="/src/assets/login-logos/bluetick.png" // apni image ka path yaha do
                alt="verify"
            ...
            <div className="flex items-center my-2">
              ...
              <span className="mx-3 text-gray-500 text-xs">
                Or continue with
              </span>
              <hr className="flex-grow border-gray-700/50" />
            </div>
          ...
          <div className="w-1/2 h-full overflow-hidden p-4 flex items-center justify-center">
            <img
              src="/Login/create.jpg"
